...
class Rose extends Flower
{
    ...
    @Override
    public String toString() { return color + " Rose"; }
}
...
class Tulip extends Flower
{
    ...
    @Override
    public String toString() { return variety + " Tulip"; }
}
...
public class Task_6_1
{
    public static void main(String[] args)
    {
        ...
        else { System.out.println("No flower found in the specified stem length range."); }
    }
}
